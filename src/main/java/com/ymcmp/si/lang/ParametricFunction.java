...
public final class ParametricFunction {
    ...
    public ParametricFunction(SiParser.DeclFuncContext ast, ParametricType<FunctionType> type) {
        this.ast = ast;
        this.type = type;
    }
    ...
    public InstantiatedFunction instantiateTypes(List<Type> types) {
        ...
        return new InstantiatedFunction(this.ast, ft, repl);
    }

    @Override
    public int hashCode() {
        return this.ast.hashCode() * 17 + this.type.hashCode();
    }
